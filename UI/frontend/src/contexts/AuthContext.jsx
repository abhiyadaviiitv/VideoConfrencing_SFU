...
export const AuthProvider = ({ children }) => {
  ...
  // If not configured, default to the same scheme as the page.
  // - local dev: typically http://localhost:5173 -> http://localhost:4000
  // - production behind ALB: https://yourdomain -> https://yourdomain (if you set VITE_API_URL),
  //   otherwise this will still use the page scheme with :4000.
