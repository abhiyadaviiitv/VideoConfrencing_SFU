...
import './Home.css'
import heroImageLocal from '../assets/cartoonish home page 2.png'

export default function Home() {
  const { user, isAuthenticated, loading } = useAuth()

  const s3BaseUrl = import.meta.env.VITE_S3_PUBLIC_URL || 'https://connective-images.s3.eu-north-1.amazonaws.com'
  const connectiveLogoS3 = `${s3BaseUrl}/assets/connective.jpg`
  const heroImageS3 = heroImageLocal
